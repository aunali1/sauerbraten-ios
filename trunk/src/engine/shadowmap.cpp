...
static struct shadowmaptexture : rendertarget
{
    ...
    const GLenum *colorformats() const
    {
        ...
        {
            static const GLenum depthtexfmts[] = { 
...
#else
        glOrthof(-shadowmapradius, shadowmapradius, -shadowmapradius, shadowmapradius, 
				renderpath==R_FIXEDFUNCTION ? 0 : -shadowmapdist, 
				renderpath==R_FIXEDFUNCTION ? ffshadowmapdist : shadowmapdist);
#endif
...
#endif
        glColor4f(shadowmapintensity/100.0f, shadowmapintensity/100.0f, shadowmapintensity/100.0f, 1);
