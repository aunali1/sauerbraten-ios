...
{
    static safe_string fullentname;
...
#else
            if(color) glColor4f(e.attr2/255.0f, e.attr3/255.0f, e.attr4/255.0f, 1.0f);
#endif
...
{   
    ...
    if(enthover >= 0)
    {
        ...
        if(entmoving && entmovingshadow==1)
        {
            ...
            glColor3ub(20, 20, 20);
#else
            glColor4f(20/255.0f, 20/255.0f, 20/255.0f, 1);
#endif
...
ICOMMAND(entget,    "",  (), entfocus(efocus, safe_string s; printent(e, s); result(s)));
