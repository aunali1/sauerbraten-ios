...
/*!***************************************************************************
 @Function			PVRTTransComputeBoundingBox
 @Output			pBoundingBox
 @Input				pV
...
*****************************************************************************/
void PVRTTransComputeBoundingBox(
...
/*!***************************************************************************
 @Function			PVRTTransComputeBoundingBoxFromInterleaved
 @Output			pBoundingBox
 @Input				pV
 @Input				nNumberOfVertices
 @Input				i32Offset
...
*****************************************************************************/
void PVRTTransComputeBoundingBoxFromInterleaved(
	PVRTBOUNDINGBOX		* const pBoundingBox,
...
/*!******************************************************************************
 @Function			PVRTTransIsBoundingBoxVisible
...
*****************************************************************************/
bool PVRTTransIsBoundingBoxVisible(
...
/*!***************************************************************************
 @Function Name		PVRTTransVec3TransformArray
 ...
 @Description		Transform all vertices [X Y Z 1] in pV by pMatrix and
 					store them in pOut.
*****************************************************************************/
void PVRTTransVec3TransformArray(
...
/*!***************************************************************************
 @Function			PVRTTransTransformArray
...
/*!***************************************************************************
 @Function			PVRTTransTransformArrayBack
 ...
 @Description		Transform all vertices in pVertex by the inverse of pMatrix
					...
					- pMatrix is the matrix used to transform the object.
*****************************************************************************/
void PVRTTransTransformArrayBack(
	PVRTVECTOR3			* const pTransformedVertex,
	...
	const PVRTMATRIX	* const pMatrix)
{
	...
	PVRTTransTransformArray(pTransformedVertex, pVertex, nNumberOfVertices, &mBack);
}

/*!***************************************************************************
 @Function			PVRTTransTransformBack
 @Output			pOut
 @Input				pV
 @Input				pM
